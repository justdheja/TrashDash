...
`));
  ...
  // code/data.js
  var TYPE_SPEED = "speed";
  var TYPE_WEIGHT = "max_weight";
  var LEVEL_SPEED = "speedLevel";
  var LEVEL_WEIGHT = "weightLevel";
  var configuration = {};
  function initDb() {
  ...
  __name(addXp, "addXp");
  function addCoin(coin_amount) {
    replit.getData("coin").then((coin) => {
      replit.setData("coin", coin + coin_amount);
    });
  }
  __name(addCoin, "addCoin");
  function deductCoin(coin_amount) {
    replit.getData("coin").then((coin) => {
      replit.setData("coin", coin - coin_amount);
    });
  }
  __name(deductCoin, "deductCoin");
  function upgrade(upgrade_type, level_type) {
  ...
  var BASE_PRICE = 100;
  var speedPrice;
  var upgrade2 = /* @__PURE__ */ __name(() => {
    speedPrice = configuration.speedLevel / 2 * BASE_PRICE;
    weightPrice = configuration.weightLevel / 2 * BASE_PRICE;
    add([
      sprite("back_btn"),
      scale(0.5),
      area(),
    ...
    for (let i2 = 0; i2 < 5; i2++) {
      if (i2 < configuration.speedLevel) {
        add([
          rect(40, 40),
          color(180, 207, 19),
          outline(1),
    ...
    for (let i2 = 0; i2 < 5; i2++) {
      if (i2 < configuration.weightLevel) {
        add([
          rect(40, 40),
          color(180, 207, 19),
          outline(1),
  ...
  function upgradeSpeed() {
    if (configuration.speedLevel >= 5) {
      return;
    }
    if (configuration.coin >= speedPrice) {
      upgrade(TYPE_SPEED, LEVEL_SPEED);
      deductCoin(speedPrice);
      updateConfig();
      go("upgrade");
    }
  }
  __name(upgradeSpeed, "upgradeSpeed");
  function upgradeWeight() {
    if (configuration.weightLevel >= 5) {
      return;
    }
    if (configuration.coin >= weightPrice) {
      upgrade(TYPE_WEIGHT, LEVEL_WEIGHT);
      deductCoin(weightPrice);
      updateConfig();
      go("upgrade");
    }
  }
  __name(upgradeWeight, "upgradeWeight");
  var upgrade_default = upgrade2;
  ...
  var settings = /* @__PURE__ */ __name(() => {
    ...
    onClick("set_money_btn", () => {
      replit.setData("xp", 1e3);
      replit.setData("coin", 1e4);
      replit.setData(TYPE_SPEED, 5);
      replit.setData(TYPE_WEIGHT, 5);
      replit.setData(LEVEL_SPEED, 1);
      replit.setData(LEVEL_WEIGHT, 1);
  ...
  // code/play.js
  function run(configuration2) {
    const MOVE_SPEED = configuration2.speed * 25;
    const MAX_WEIGHT = configuration2.maxWeight;
    const TIMER = 60;
    ...
    __name(calculateSpeed, "calculateSpeed");
    ...
    __name(generateTrash, "generateTrash");
  }
  __name(run, "run");
  ...
  scene("menu", () => {
    ...
    onClick("play_btn", (play_btn2) => go("cut_scene"));
    onClick("settings_btn", () => go("settings"));
    onClick("upgrade_btn", (upgrade_btn2) => go("upgrade"));
  });
  scene("upgrade", () => {
    upgrade_default();
  });
